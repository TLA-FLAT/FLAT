...
class CurlConnection extends HttpConnection {
  ...
  protected function setupCurlContext($url) {
    ...
    curl_setopt(self::$curlContext, CURLOPT_SSL_VERIFYHOST, $this->verifyHost ? 2 : 0);
    
    //curl_setopt(self::$curlContext, CURLOPT_SSL_CIPHER_LIST, 'TLSv1.2:TLSv1:SSLv3:SSLv2');   
    curl_setopt(self::$curlContext, CURLOPT_SSL_CIPHER_LIST, 'RC4-SHA:RC4-MD5');   
