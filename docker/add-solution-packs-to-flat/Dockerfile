...
#
# Audio solution pack, Islandora Batch Derivative Trigger and its dependencies
#
...
RUN cd /tmp/islandora &&\
	...
	unzip islandora_solution_pack_audio-7.x-1.13.zip -d /var/www/html/$FLAT_NAME/sites/all/modules/contrib/ &&\
	wget "https://github.com/Islandora/php_lib/archive/7.x-1.13.zip" &&\
	mv 7.x-1.13.zip php_lib-7.x-1.13.zip &&\
	unzip php_lib-7.x-1.13.zip -d /var/www/html/$FLAT_NAME/sites/all/modules/contrib/ &&\
	cd /tmp/islandora &&\
	wget "https://github.com/Islandora/objective_forms/archive/7.x-1.13.zip" &&\
	mv 7.x-1.13.zip objective_forms-7.x-1.13.zip &&\
	unzip objective_forms-7.x-1.13.zip -d /var/www/html/$FLAT_NAME/sites/all/modules/contrib/ &&\
	cd /tmp/islandora &&\
	wget "https://github.com/Islandora/islandora_xml_forms/archive/7.x-1.13.zip" &&\
	mv 7.x-1.13.zip islandora_xml_forms-7.x-1.13.zip &&\
	unzip islandora_xml_forms-7.x-1.13.zip -d /var/www/html/$FLAT_NAME/sites/all/modules/contrib/ &&\
	cd /tmp/islandora &&\
