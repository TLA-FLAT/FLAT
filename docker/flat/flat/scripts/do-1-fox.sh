...
lat2fox.sh -e=$CMD_EXTENSION -h -n=1000 -r=/app/flat/tmp/relations.xml -f=/app/flat/fox -x=/app/flat/tmp/fox-error -p=/app/flat/deposit/policies -i=/lat -b=$FLAT_ICON_DIR /app/flat/cmd
ERR=$?
